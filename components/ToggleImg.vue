...
<template>
  <div class="text-center absolute bottom-7 items-center text-xs">
    <span class="md:hover:bg-black md:hover:text-white pl-2 pr-2 font-serif" @click="Prev">Prev</span>
    <span class="text-xs pl-1 pr-1">/</span>
    <span class="md:hover:bg-black md:hover:text-white pl-2 pr-2 font-serif" @click="Next">Next</span>
    <slot />
  </div>
</template>
